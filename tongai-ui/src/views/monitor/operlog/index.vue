    ...
    <el-drawer title="操作日志详细" :visible.sync="open">
      <div class="drawer__content">
        <el-descriptions direction="vertical" :column="1" border>
          ...
          <el-descriptions-item label="登录信息：">{{ form.operName }} / {{ form.operIp }} / {{ form.operLocation }}</el-descriptions-item>
...
<!--              <div class="jsonCode">-->
<!--                <codemirror :style="{ height: '100%' }" :options="options"-->
<!--                            v-model="form.operParam"></codemirror>-->
<!--              </div>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="24">-->
...
<!--              <div class="jsonCode">-->
<!--                <codemirror :style="{ height: '100%' }" :options="options"-->
<!--                            v-model="form.jsonResult"></codemirror>-->
<!--              </div>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="6">-->
