<template>
  <div class="app-container">
    ...
    <!-- 调度日志详细 -->
    <el-drawer title="调度日志详细" :visible.sync="open" width="700px">
      <div class="drawer__content">
        <el-descriptions direction="vertical" :column="1" border>
          <el-descriptions-item label="日志序号：">{{ form.jobLogId }}</el-descriptions-item>
          ...
          <el-descriptions-item label="异常信息：" v-if="form.status === '1'">
            <pre><code class="hljs" v-html="highlightedCode(form.exceptionInfo)"></code></pre>
          </el-descriptions-item>
        </el-descriptions>
      </div>
    </el-drawer>
