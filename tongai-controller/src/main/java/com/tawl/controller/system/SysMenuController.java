...
public class SysMenuController extends BaseController
{
    ...
    @GetMapping("/getMaxChildSort/{parentId}")
    public AjaxResult getMaxChildSort(@PathVariable("parentId") Long parentId)
    {
        return AjaxResult.success(menuService.selectChildMaxSort(parentId) + 1);
    }
}