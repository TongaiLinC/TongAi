...
import com.tawl.common.exception.file.FileNameLengthLimitExceededException;
import com.tawl.common.exception.file.FileSizeLimitExceededException;
import com.tawl.common.exception.file.InvalidExtensionException;
import com.tawl.common.utils.DateUtils;
import com.tawl.common.utils.StringUtils;
import com.tawl.common.utils.uuid.IdUtils;
import com.tawl.common.utils.uuid.Seq;
...
public class FileUploadUtils {
   ...
   * 默认上传的地址
   */
  private static String defaultBaseDir = TongAiConfig.getProfile();
  ...
  public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
    int dirLastIndex = TongAiConfig.getProfile().length() + 1;
