package com.tawl.common.core.controller;
...
import com.tawl.common.core.page.PageDomain;
import com.tawl.common.core.page.TableDataInfo;
import com.tawl.common.core.page.TableSupport;
import com.tawl.common.exception.DemoModeException;
import com.tawl.common.utils.*;
...
public class BaseController {
    ...
    public void init(HttpServletRequest httpServletRequest, HttpServletResponse response) throws IOException {
        ...
        // 增删改 请求
        if (tongAiConfig.isDemoEnabled() && ("DELETE".equals(httpServletRequest.getMethod()) || "POST".equals(httpServletRequest.getMethod())
